...
public interface JwtProperties {
    ...
    long EXPIRED_TIME = (60 * 1000L) *10; // 10일 (1/1000초)
    String TOKEN_PREFIX = "Bearer ";
    String HEADER_NAME = "Authorization";

    String LOGIN_URL = "/guest/login";
//    header: Authorization
//    secret: 562d5b8be9e980dd6b7e2018335e21bdd0b359ab8c6df43bebaf513d448e2defe02483648a6164816ff98254037c8af569e2d678e06ce2d00b01b645619a58ea
//    expired: 600000
//    tokenPrefix: Bearer
}
